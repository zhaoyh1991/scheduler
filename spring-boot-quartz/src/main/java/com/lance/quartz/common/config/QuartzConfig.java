...
public class QuartzConfig {
	...
	public Properties quartzProperties() throws IOException {
		...
		prop.put("org.quartz.dataSource.quartzDataSource.URL", "jdbc:mysql://localhost:3306/task");
		prop.put("org.quartz.dataSource.quartzDataSource.user", "root");
		prop.put("org.quartz.dataSource.quartzDataSource.password", "zhaoyuanhua");
